...
## fimo
`--parse-genomic-coord`: When this option is specified, each FASTA sequence header is checked for UCSC style genomic coordinates (e.g., `chr1:156887119-156887619`). The sequence ID in the FASTA header should have the form:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNTAwNDM1MTUsLTE2MzYyMzU3MDAsLT
