...
The binding of PRDM9 will introduce genetic variants in meiotic recombination. PRDM9 normally just has expression in testis, but it is also found to express in cancer cells. Therefore, we want to the association between PRDM9 binding regions and somatic mutations
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYwNjExMTkzMCwxNDM0MTE2MzE4LC0xMz
