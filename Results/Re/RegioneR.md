...
test (statistically evaluate the association between different RS using a permutation test approach)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMjcyMTcwNDYsLTcyMjE5NjksLTIxND
IzMjUwNywtMTM4NTE5MjcyNSwtMTkwMTkxNDM5NV19
-->